...
public final class asideFunctionalPromotions_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write(" \t$(\"#futbolNonStop-button\").click(function (){\r\n");
      out.write(" \t\teverilionConection();\r\n");
      out.write("\t}); \r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("function everilionConection(){\r\n");
      out.write("\t$.doAjax({\r\n");
      out.write("\t\toptions: {\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\turl: \"./everilion/connection_info\",\r\n");
      out.write("\t\t\tasync: false\r\n");
      out.write("\t\t},\r\n");
      out.write("\t\thandlers: {\r\n");
      out.write("\t\t\tsuccess: function(data, textStatus, jqXHR) {\r\n");
      out.write("\t\t\t\tif(jqXHR.status == '202'){\r\n");
      out.write("\t\t\t\t\t$.showInformationDialog({\r\n");
      out.write("\t\t\t\t\t\ttitle:\t'Promoci&oacute;n v&aacute;lida para tarjetas del Banco.',\r\n");
      ...
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\tvar newWindow = window.open(\"\", \"EverilionWindow\", \"width=1000, height=700, scrollbars=yes\");\r\n");
      out.write("\t\t\t\t\tnewWindow.document.write(data);\r\n");
      out.write("\t\t\t\t\tnewWindow.document.getElementById('connectionForm').submit();\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t },\r\n");
      out.write("\t\t\thandledError: function(data)\r\n");
      out.write("        \t{\r\n");
      out.write("        \t\t$.showNonFatalError({text: data.message, onClose: null });\r\n");
      out.write("        \t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}); \r\n");
      out.write("}\r\n");
  ...
  private boolean _jspx_meth_sec_005fauthentication_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/globalPosition/asideFunctionalPromotions.jsp(5,0) name = property type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
    _jspx_th_sec_005fauthentication_005f0.setProperty("details.isPerson");
    // /WEB-INF/views/globalPosition/asideFunctionalPromotions.jsp(5,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
